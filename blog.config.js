...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '2265a32f76954fd28c9ebf0d5a7604c4',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '健康|活力|美好，每一个词汇都属于你🩷', 
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blueberrystudio.tokyo/', // 网站地址
  ...
  CONTACT_XIAOHONGSHU: process.env.NEXT_PUBLIC_CONTACT_XIAOHONGSHU || '', // XIAOHONGSHU主页
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '[BlueberryStudio]', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '🫐 Just give me one more bite.', // 站点描述，被notion中的页面描述覆盖
