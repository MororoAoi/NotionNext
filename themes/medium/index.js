            ...
            <div id='theme-medium' className={`${siteConfig('FONT_STYLE')} bg-transparent dark:bg-hexo-black-gray w-full h-full min-h-screen justify-center dark:text-gray-300 scroll-smooth`}>
                ...
                <main id='wrapper' className={(JSON.parse(siteConfig('LAYOUT_SIDEBAR_REVERSE')) ? 'flex-row-reverse' : '') + 'relative flex justify-between w-full h-full mx-auto'}>
                    ...
                    <div id='container-wrapper' className='w-full relative z-10'>
                        ...
                        <div id='container-inner' className={`px-8 ${fullWidth ? '' : 'max-w-5xl'} justify-center mx-auto min-h-screen`}>
                            <Transition
                                show={!onLoading}
                                appear={true}
                    ...
                    {fullWidth
                      ...
                      : <div className={`hidden xl:block dark:border-transparent w-96 relative z-10 ${siteConfig('MEDIUM_RIGHT_PANEL_DARK', null, CONFIG) ? 'bg-hexo-black-gray dark' : ''}`}>
                            <div className='py-8 px-6 sticky top-0'>
                                <Tabs>
                                    {slotRight}
                                    <div>
...
const LayoutMemos = (props) => {
  ...
  return  (   	
  <div className="w-full lg:hover:shadow rounded-md lg:rounded-md lg:px-1 lg:py-2 article">
