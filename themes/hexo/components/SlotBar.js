...
export default function SlotBar(props) {
  ...
  if (tag) {
    return <div className="cursor-pointer px-3 py-2 mb-2 font-light hover:text-orange-400 dark:hover:text-orange-300 transform dark:text-white">
    ...
    return <div className="cursor-pointer text-lg px-5 py-1 mb-2 font-light hover:text-orange-400 dark:hover:text-orange-300 transform dark:text-white">
